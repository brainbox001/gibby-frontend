...
function Deposit({
  ...
  async function handleSubmit(e: any) {
    ...
    if (
      !!inputValues.goal &&
      parseInt(inputValues.target) > 999 &&
      parseInt(inputValues.startAmount) > 499 &&
      parseInt(inputValues.startAmount) <= parseInt(inputValues.target) &&
      ...
      const duration =
        inputValues.duration * Datetime[inputValues.durationSelect];
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="w-21 sm:w-21.6 m-auto shadow-xl rounded-xl mt-10">
            ...
            <div className="flex flex-col justify-center items-center relative bg-white">
              <form onSubmit={handleSubmit}>
                <div>
                  <label
                    className="block italic text-blue-500 font-thin my-0.5"
                    htmlFor="goal"
                  >
                ...
                <div className="pt-2">
                  <label
                    className="italic text-blue-500 font-thin px-2"
                    htmlFor="duration"
                  >
                    Lock duration:
                  </label>
                ...
                <div className="text-center py-4.5">
                  <button
                    type="submit"
                    className="bg-blue-600 text-white px-3.5 py-0.5 rounded"
                  >
