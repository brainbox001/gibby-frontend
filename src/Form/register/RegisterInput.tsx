    ...
    return (<div className="mx-3 mb-14 sm:mx-14 md:mx-16 lg:mx-18 xl:mx-21.5">
        <div className="text-center mt-12 shadow-2xl rounded-4xl w-full">
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-3 sm:gap-4 reg-form-div mt-10 mb-4">
                <div>
                <label ref={emailLabelRef} className="hidden" htmlFor="email">Use a valid email address</label>
                <input className="placeholder-place-col w-21 max-[380px]:w-18 h-9 focus:outline-none border-blue-600 border-2 rounded-4xl pl-2" ref={emailRef} onChange={handleValidInput} type="text" name="email" id="email" placeholder="Email" />
                </div>

                <div>
                <label ref={firstNameLabelRef} className="hidden" htmlFor="first-name">Name can't be empty</label>
                <input className="placeholder-place-col w-21 max-[380px]:w-18 h-9 focus:outline-none border-blue-600 border-2 rounded-4xl pl-2" ref={firstNameRef} onChange={handleValidInput} type="text" name="first-name" id="first-name" placeholder="First name" />
                </div>
                
                <div>
                <label ref={lastNameLabelRef}  className="hidden" htmlFor="last-name">Name can't be empty</label>
                <input className="placeholder-place-col w-21 max-[380px]:w-18 h-9 focus:outline-none border-blue-600 border-2 rounded-4xl pl-2" ref={lastNameRef} onChange={handleValidInput} type="text" name="last-name" id="last-name pl-2" placeholder="Last name" />
                </div>
                ...
                <input className="placeholder-place-col w-18 max-[380px]:w-16.5 h-9 inline mr-2 focus:outline-none border-blue-600 border-2 rounded-4xl pl-2" ref={passwordRef} type={typeChange ? 'text' : 'password'} onChange={handlePasswordChange} name="password" id="password" autoComplete="new-password" placeholder="Password" />
