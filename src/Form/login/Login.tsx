        ...
        <>
         ...
         <div className="mb-14">
            <div className="mt-10 mx-3 shadow-2xl shadow-blue-200 sm:mx-14 md:mx-16 lg:mx-18 xl:mx-21.5 rounded-2xl">
                ...
                <div className={`${!!status.error ? 'pb-3.5' : ''} mt-10 text-center font-semibold text-rose-600`}>{status.error}</div>
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 gap-3 place-items-center">

                    <div className=" mb-9">
                    <input className="placeholder-place-col w-21 max-[380px]:w-18 h-9 focus:outline-none border-blue-600 border-2 rounded-4xl pl-2" type="text" value={form.email} name="email" onChange={handleEmailChange} id="email-id" placeholder="Email" />
                    </div>
                    
                    <div className="mb-3">
                    <input className="placeholder-place-col w-18 max-[380px]:w-16.5 h-9 inline mr-2 focus:outline-none border-blue-600 border-2 rounded-4xl pl-2"type={typeChange ? 'text' : 'password'} value={form.password} onChange={handlePasswordChange} name="password" id="password" placeholder="Password" />
